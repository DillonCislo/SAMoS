/*!
 * \file population_cell_random.cpp
 * \author Dillon Cislo, dilloncislo@gmail.com
 * \date 26-Apr-2022
 * \brief Implementation of PopulationCellRandom class.
 */ 

#include "population_cell_random.hpp"
 ...
 *  
*/
void PopulationCellRandom::divide(int t)
{
    ...
    for (int i = 0; i < N; i++)
    {
      ...
      { 
        ...
        if (m_rng->drnd() < prob_div)  // Only internal verices can divide
        {
          ...
          double phi1 = 2.0 * M_PI * m_rng->drnd();
          double phi2 = 2.0 * M_PI * m_rng->drnd();
 ...
 * 
*/
void PopulationCellRandom::remove(int t)
{
 ...
 *  
*/
void PopulationCellRandom::grow(int t)
{
